import { Info, TrendingUp } from "lucide-react";
  ...
  export default function MetricCard({
    ...
    const variationColor = isPositive ? "var(--success)" : "var(--destructive)";
      ...
      >
        <div className="relative size-full">
          <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start px-5 py-4 relative size-full">
            {/* Card Background */}
            <div className="absolute bg-card inset-0 rounded-xl" data-name="Card">
              <div className="absolute border border-border border-solid inset-0 pointer-events-none rounded-xl" />
            </div>
            ...
            <div
              ...
              data-name="Header"
            >
              <div className="basis-0 flex flex-col font-semibold grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-foreground text-[16px] text-left">
            ...
            >
              ...
              >
                {/* Value */}
                <div
                  className="box-border content-stretch flex flex-row font-bold gap-1.5 items-baseline justify-start leading-[0] not-italic pl-0 pr-2 py-0 relative shrink-0 text-foreground text-left text-nowrap"
                  data-name="Value"
                >
              ...
              {showProgress && (
                ...
                >
                  <div
                    className="bg-muted h-1 overflow-clip relative rounded shrink-0 w-full"
                    data-name="🌮 Progress (bar)"
                  >
                    <div
              ...
              {/* Subtitle */}
              <div className="flex flex-col font-medium justify-center leading-[0] not-italic relative shrink-0 text-muted-foreground text-[14px] text-left w-full">
