...
export function ActionPage() {
  return (
    <div className="space-y-12">
      <ContentSection title="Button Variants" noBorder>
      ...
      <ContentSection title="Button Sizes" noBorder>
      ...
      <ContentSection title="Button States" noBorder>
        <div className="flex flex-wrap gap-2">
      ...
      <ContentSection title="Basic Chips" noBorder>
        <div className="flex flex-wrap gap-2">
          <Chip label="Default" />
      ...
      <ContentSection title="Chip Sizes" noBorder>
        <div className="flex flex-wrap items-center gap-2">
      ...
      <ContentSection title="Avatar Sizes" noBorder>
      ...
      <ContentSection title="Avatar Variants" noBorder>
        <div className="flex items-center gap-4">
